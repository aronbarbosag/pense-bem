...
export function AnswerOptions({ feedback, onAnswer, question, selected }) {
  return (
    <div className="mt-5 grid gap-3">
      {question.options.map((option, index) => {
        ...
        return (
          ...
          >
            <span className={`grid h-6 w-6 place-items-center rounded-full border border-cyan-300/70 text-xs font-black ${ANSWER_LETTERS[index].bg} text-cyan-300 group-hover:border-amber-300 group-hover:text-amber-300`} />
